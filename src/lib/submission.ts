 ...
 * Available in:
 *   - Cloudflare Workers (global crypto.randomUUID)
 ...
 * require() is NEVER used — this module is pure ESM.
 */
export function generateSubmissionNumber(): string {
  ...
  // Hard fail — never fall back to Math.random()
  // This path is unreachable on Node.js >= 15 or Cloudflare Workers.
  throw new Error(
